...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(f"Welcome {user.first_name}! Use /referral to see your referral count or /leaderboard to see the top referrers.")
...
async def track_invites(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(f"Referral tracked! You have referred {referral_data[inviter_id]} people.")
...
async def random_winner(update: Update, context: CallbackContext) -> None:
    ...
    if sorted_referrals:
        ...
        await update.message.reply_text(f"🎉 The random winner from the top referrers is {winner.first_name} with {count} referrals!")
    else:
